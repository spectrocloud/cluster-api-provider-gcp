...
create-management-cluster: $(KUSTOMIZE) $(ENVSUBST)
	...
	# Deploy CAPI
	curl --retry $(CURL_RETRIES) -sSL https://github.com/kubernetes-sigs/cluster-api/releases/download/v0.4.2/cluster-api-components.yaml | $(ENVSUBST) | kubectl apply -f -
